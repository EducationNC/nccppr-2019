    ...
    <div class="container">
      <div class="row">
          ...
          <div class="entry-content">
            ...
            if (! empty($feature) ) { ?>
              <div class="featured-pick extra-padding" data-source="<?php echo $feature[0]['link']; ?>">
                ...
                <?php echo $feature[0]['intro_text']; ?>... <a class="more" href="<?php echo $feature[0]['link']; ?>" target="_blank" onclick="ga('send', 'event', 'fridayfive', 'click');">Read the rest <span class="icon-external-link"></span></a></p></a>
        ...
        <div class="col-md-3 col-lg-push-1">
          ...
          <p><br /><a href="/feed/fridayfive/" target="_blank" class="btn btn-default"><span class="icon-rss"></span> RSS feed</a></p>
        </div>
      </div>
    </div>
  </article>
