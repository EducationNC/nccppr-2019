...
$appearances = wp_get_post_terms(get_the_id(), 'appearance');
  ...
  $app_hide[] = array_search('News', array_column($appearances, 'name'));
...
// EdNews label
if ($post_type == 'ednews') {
  echo '<span class="label">Friday@Five</span>';
}

// FridayFive label
if ($post_type == 'FridayFive') {
  echo '<span class="label">Friday@Five</span>';// Video label
 } 
