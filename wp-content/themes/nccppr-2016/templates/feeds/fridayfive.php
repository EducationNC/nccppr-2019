...
<channel>
  <title><?php bloginfo_rss('name'); ?> - Friday@Five Feed</title>
  ...
  <?php while($fridayfive->have_posts()) : $fridayfive->the_post(); ?>
    <item>
