...
function custom_rss() {
  add_feed('fridayfive', __NAMESPACE__ . '\\fridayfive');
  add_feed('grareporter', __NAMESPACE__ . '\\grareporter');
...
function fridayfive() {
  get_template_part('templates/feeds/fridayfive');
}
// Function for GRA Reporter feed
function grareporter() {
  get_template_part('templates/feeds/grareporter');
}
