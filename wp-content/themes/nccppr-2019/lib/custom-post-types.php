...
function register_post_types() {
	...
	register_post_type( 'fridayfive',
		array('labels' => array(
				'name' => 'Friday@Five',
				'singular_name' => 'Friday@Five',
				'add_new' => 'Add New',
				'add_new_item' => 'Add New Friday@Five',
				'edit' => 'Edit',
				'edit_item' => 'Edit Friday@Five',
				'new_item' => 'New Friday@Five',
				'view_item' => 'View Friday@Fives',
				'search_items' => 'Search Friday@Fives',
				'not_found' =>  'Nothing found in the Database.',
				'not_found_in_trash' => 'Nothing found in Trash',
				'parent_item_colon' => ''
			), /* end of arrays */
	...
	register_post_type( 'grareporter',
		array('labels' => array(
				'name' => 'GRA Reporter',
				'singular_name' => 'GRA Reporter',
				'add_new' => 'Add New',
				'add_new_item' => 'Add New GRA Reporter',
				'edit' => 'Edit',
				'edit_item' => 'Edit GRA Reporter',
				'new_item' => 'New GRA Reporter',
				'view_item' => 'View GRA Reporters',
				'search_items' => 'Search GRA Reporters',
				'not_found' =>  'Nothing found in the Database.',
				'not_found_in_trash' => 'Nothing found in Trash',
				'parent_item_colon' => ''
			), /* end of arrays */
...
register_taxonomy( 'appearance',
	array('post', 'map', 'edtalk', 'flash-cards','fridayfive','grareporter'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
	array('hierarchical' => true,     /* if this is true it acts like categories */
		'labels' => array(
			'name' => __( 'Appearances' ),
...
*/
	...
	if ($query->is_category() && $query->is_main_query()) {
		$query->set('post_type', ['post', 'edtalk', 'fridayfive', 'grareporter']);
	}
	...
	if ($query->is_day()) {
		$query->set('post_type', ['post', 'map', 'fridayfive', 'edtalk', 'grareporter', 'flash-cards']);
		$tax_query = array(
			array(
				'taxonomy' => 'appearance',
				'field' => 'slug',
